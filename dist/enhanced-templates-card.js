 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const f=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:e=>e}),S=` ${s} `;class w{constructor(e,t,i,s){this.strings=e,this.values=t,this.type=i,this.processor=s}getHTML(){const e=this.strings.length-1;let t="",i=!1;for(let r=0;r<e;r++){const e=this.strings[r],o=e.lastIndexOf("\x3c!--");i=(o>-1||i)&&-1===e.indexOf("--\x3e",o+1);const a=c.exec(e);t+=null===a?e+(i?S:n):e.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+s}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");let t=this.getHTML();return void 0!==f&&(t=f.createHTML(t)),e.innerHTML=t,e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function O(e){let t=V.get(e.type);void 0===t&&(t={stringsArray:new WeakMap,keyString:new Map},V.set(e.type,t));let i=t.stringsArray.get(e.strings);if(void 0!==i)return i;const n=e.strings.join(s);return i=t.keyString.get(n),void 0===i&&(i=new o(e,e.getTemplateElement()),t.keyString.set(n,i)),t.stringsArray.set(e.strings,i),i}const V=new Map,D=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,s){const n=t[0];if("."===n){return new N(e,t.slice(1),i).parts}if("@"===n)return[new T(e,t.slice(1),s.eventContext)];if("?"===n)return[new $(e,t.slice(1),i)];return new C(e,t,i).parts}handleTextExpression(e){return new P(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const ie={};class se extends B{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(Array.isArray(e)){const t=(e,i)=>e.reduceRight((e,i)=>Array.isArray(i)?t(i,e):(e.add(i),e),i),i=t(e,new Set),s=[];i.forEach(e=>s.unshift(e)),this._styles=s}else this._styles=void 0===e?[]:[e];this._styles=this._styles.map(e=>{if(e instanceof CSSStyleSheet&&!Q){const t=Array.prototype.slice.call(e.cssRules).reduce((e,t)=>e+t.cssText,"");return new ee(String(t),X)}return e})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Q?this.renderRoot.adoptedStyleSheets=e.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==ie&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return ie}}se.finalized=!0,se.render=(e,t,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const n=s.scopeName,r=D.has(t),o=Y&&11===t.nodeType&&!!t.host,a=o&&!q.has(n),d=a?document.createDocumentFragment():t;if(((e,t,s)=>{let n=D.get(t);void 0===n&&(i(t,t.firstChild),D.set(t,n=new P(Object.assign({templateFactory:O},s))),n.appendInto(t)),n.setValue(e),n.commit()})(e,d,Object.assign({templateFactory:z(n)},s)),a){const e=D.get(d);D.delete(d);const s=e.value instanceof v?e.value.template:void 0;L(n,d,s),i(t,t.firstChild),t.appendChild(d),D.set(t,e)}!r&&o&&window.ShadyCSS.styleElement(t.host)};var ne=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,re="[^\\s]+",oe=/\[([^]*?)\]/gm;function ae(e,t){for(var i=[],s=0,n=e.length;s<n;s++)i.push(e[s].substr(0,t));return i}var de=function(e){return function(t,i){var s=i[e].map((function(e){return e.toLowerCase()})).indexOf(t.toLowerCase());return s>-1?s:null}};function le(e){for(var t=[],i=1;i<arguments.length;i++)t[i-1]=arguments[i];for(var s=0,n=t;s<n.length;s++){var r=n[s];for(var o in r)e[o]=r[o]}return e}var ce=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],he=["January","February","March","April","May","June","July","August","September","October","November","December"],ue=ae(he,3),pe={dayNamesShort:ae(ce,3),dayNames:ce,monthNamesShort:ue,monthNames:he,amPm:["am","pm"],DoFn:function(e){return e+["th","st","nd","rd"][e%10>3?0:(e-e%10!=10?1:0)*e%10]}},_e=le({},pe),me=function(e,t){for(void 0===t&&(t=2),e=String(e);e.length<t;)e="0"+e;return e},ge={D:function(e){return String(e.getDate())},DD:function(e){return me(e.getDate())},Do:function(e,t){return t.DoFn(e.getDate())},d:function(e){return String(e.getDay())},dd:function(e){return me(e.getDay())},ddd:function(e,t){return t.dayNamesShort[e.getDay()]},dddd:function(e,t){return t.dayNames[e.getDay()]},M:function(e){return String(e.getMonth()+1)},MM:function(e){return me(e.getMonth()+1)},MMM:function(e,t){return t.monthNamesShort[e.getMonth()]},MMMM:function(e,t){return t.monthNames[e.getMonth()]},YY:function(e){return me(String(e.getFullYear()),4).substr(2)},YYYY:function(e){return me(e.getFullYear(),4)},h:function(e){return String(e.getHours()%12||12)},hh:function(e){return me(e.getHours()%12||12)},H:function(e){return String(e.getHours())},HH:function(e){return me(e.getHours())},m:function(e){return String(e.getMinutes())},mm:function(e){return me(e.getMinutes())},s:function(e){return String(e.getSeconds())},ss:function(e){return me(e.getSeconds())},S:function(e){return String(Math.round(e.getMilliseconds()/100))},SS:function(e){return me(Math.round(e.getMilliseconds()/10),2)},SSS:function(e){return me(e.getMilliseconds(),3)},a:function(e,t){return e.getHours()<12?t.amPm[0]:t.amPm[1]},A:function(e,t){return e.getHours()<12?t.amPm[0].toUpperCase():t.amPm[1].toUpperCase()},ZZ:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+me(100*Math.floor(Math.abs(t)/60)+Math.abs(t)%60,4)},Z:function(e){var t=e.getTimezoneOffset();return(t>0?"-":"+")+me(Math.floor(Math.abs(t)/60),2)+":"+me(Math.abs(t)%60,2)}},ye=function(e){return+e-1},ve=[null,"[1-9]\\d?"],fe=[null,re],Se=["isPm",re,function(e,t){var i=e.toLowerCase();return i===t.amPm[0]?0:i===t.amPm[1]?1:null}],we=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(e){var t=(e+"").match(/([+-]|\d\d)/gi);if(t){var i=60*+t[1]+parseInt(t[2],10);return"+"===t[0]?i:-i}return 0}],be=(de("monthNamesShort"),de("monthNames"),{default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",isoDate:"YYYY-MM-DD",isoDateTime:"YYYY-MM-DDTHH:mm:ssZ",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"});var xe=function(e,t,i){if(void 0===t&&(t=be.default),void 0===i&&(i={}),"number"==typeof e&&(e=new Date(e)),"[object Date]"!==Object.prototype.toString.call(e)||isNaN(e.getTime()))throw new Error("Invalid Date pass to format");var s=[];t=(t=be[t]||t).replace(oe,(function(e,t){return s.push(t),"@@@"}));var n=le(le({},_e),i);return(t=t.replace(ne,(function(t){return ge[t](e,n)}))).replace(/@@@/g,(function(){return s.shift()}))},Ce=(function(){try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleString("i")}catch(e){return"RangeError"===e.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(e){return"RangeError"===e.name}}(),{version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"}),Ee={hide_intro:"Hide Introduction",hide_title:"Hide Title",registry:"Registry"},Pe={one:"Area",other:"Areas"},$e={one:"Entity",other:"Entities"},Ne={area:"Update settings for rooms (areas). After updating, you may need to rebuild the counters from the settings menu to see your changes.",entity:"Update settings for devices (entities). After updating, you may need to rebuild the counters from the settings menu to see your changes."},Ae={entity_type:"Entity Type",sort_order:"Sort Order",visible:"Visible",visible_area_description:"Areas that are not visible will not be displayed automatically in dashboards."},Me={area:"Area Settings",entity:"Entity Settings"},Te={common:Ce,config:Ee,area:Pe,entity:$e,intro:Ne,settings:Ae,title:Me};const ke={en:Object.freeze({__proto__:null,common:Ce,config:Ee,area:Pe,entity:$e,intro:Ne,settings:Ae,title:Me,default:Te})};function Oe(e,t="",i=""){const s=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let n;try{n=e.split(".").reduce((e,t)=>e[t],ke[s])}catch(t){n=e.split(".").reduce((e,t)=>e[t],ke.en)}return void 0===n&&(n=e.split(".").reduce((e,t)=>e[t],ke.en)),""!==t&&""!==i&&(n=n.replace(t,i)),n}let Ve=class extends se{constructor(){super(...arguments),this._initialized=!1}setConfig(e){this._config=e,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}render(){var e,t,i;return this._helpers?(this._helpers.importMoreInfoControl("climate"),R`
    ...
    `}};e([G({attribute:!1})],Ve.prototype,"hass",void 0),e([K()],Ve.prototype,"_config",void 0),e([K()],Ve.prototype,"_helpers",void 0),Ve=e([J("enhanced-templates-card-editor")],Ve);console.info(`%c  ENHANCED-TEMPLATES-CARD  \n%c  ${Oe("common.version")} 0.1.0            `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"enhanced-templates-card",name:"Enhanced Templates Settings Card",description:"Update areas or entities with custom settings."});let De=class extends se{constructor(){super(...arguments),this._last_hash=""}static async getConfigElement(){return document.createElement("enhanced-templates-card-editor")}static getStubConfig(){return{}}set hass(e){var t;this._hass=e,this._entity_types||this._load_entity_types();const i=null===(t=location.hash)||void 0===t?void 0:t.substr(1);i&&i!==this._last_hash&&("entity"===this.config.registry?this._entityPicked({detail:{value:i}}):this._areaPicked({detail:{value:i}})),this._last_hash=i}async setConfig(e){e.test_gui&&function(){var e=document.querySelector("home-assistant");if(e=(e=(e=(e=(e=(e=(e=(e=e&&e.shadowRoot)&&e.querySelector("home-assistant-main"))&&e.shadowRoot)&&e.querySelector("app-drawer-layout partial-panel-resolver"))&&e.shadowRoot||e)&&e.querySelector("ha-panel-lovelace"))&&e.shadowRoot)&&e.querySelector("hui-root")){var t=e.lovelace;return t.current_view=e.___curView,t}return null}().setEditMode(!0),this.config=e,await(async()=>{if(customElements.get("ha-entity-picker"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"developer-tools"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("developer-tools-router");const t=document.createElement("developer-tools-router");await t.routerOptions.routes.state.load()})(),await(async()=>{if(customElements.get("ha-area-picker"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.devices.load(),await customElements.whenDefined("ha-config-device-page");document.createElement("ha-config-device-page").firstUpdated({}),await t.routerOptions.routes.entities.load(),await customElements.whenDefined("ha-config-entities");document.createElement("ha-config-entities").firstUpdated({})})(),this.addEventListener("config-changed",this.handleConfigChanged)}handleConfigChanged(e){this.config=e.detail.config}async _load_entity_types(){this._entity_types=await this._hass.callWS({type:"enhanced_templates_entity_types"})||[]}render(){return"area"===this.config.registry?this._areaSettings():this._entitySettings()}_disabled(){return"area"===(this.config.registry||"area")?!this._selectedArea||""===this._selectedArea.id:!this._selectedEntity||""===this._selectedEntity.entity_id}_areaSettings(){var e,t;return R`
      <ha-card .header=${this.config.hide_title?null:Oe("title.area")}>
        <div class="card-content">
          ${this.config.hide_intro?null:R`<p>${Oe("intro.area")}</p>`}
          <div>
            <ha-area-picker
              .hass=${this._hass}
          ...
          <div class="row">
            ...
            <div>
              <div class=${this._disabled()?"disabled":""}>${Oe("settings.visible")}</div>
    ...
    `}_entitySettings(){var e,t,i,s,n,r,o,a;return R`
      <ha-card .header=${this.config.hide_title?null:Oe("title.entity")}>
        <div class="card-content">
          ${this.config.hide_intro?null:R`<p>${Oe("intro.entity")}</p>`}
          <div>
            <ha-entity-picker
              .hass=${this._hass}
    ...
    `}getCardSize(){return 8+(this.config.hide_title?0:2)+(this.config.hide_intro?0:1)}};e([G({attribute:!1})],De.prototype,"_hass",void 0),e([K()],De.prototype,"config",void 0),e([K()],De.prototype,"_area_id",void 0),e([K()],De.prototype,"_entity_type",void 0),e([K()],De.prototype,"_entity_types",void 0),e([K()],De.prototype,"_icon",void 0),e([K()],De.prototype,"_name",void 0),e([K()],De.prototype,"_selectedArea",void 0),e([K()],De.prototype,"_selectedEntity",void 0),e([K()],De.prototype,"_sortOrder",void 0),e([K()],De.prototype,"_visible",void 0),e([K()],De.prototype,"_last_hash",void 0),De=e([J("enhanced-templates-card")],De);export{De as EnhancedTemplateCard};
